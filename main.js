...
const routes = [
    ...
    {
        path: 'portfolio',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_portfolio_portfolio_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/portfolio/portfolio.module */ 9804)).then(m => m.PortfolioPageModule)
    },
    {
        path: '**',
        redirectTo: 'portfolio'
